 ...
 */
// @ts-ignore
export function createShopFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    return deserializeIntoShop;
}
/**
 * Creates a new instance of the appropriate class based on discriminator value
 * @param parseNode The parse node to use to read the discriminator value and create the object
 ...
 */
// @ts-ignore
export function deserializeIntoShop(shop: Partial<Shop> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "caption": n => { shop.caption = n.getStringValue(); },
        "comment": n => { shop.comment = n.getStringValue(); },
        "createdByID": n => { shop.createdByID = n.getNumberValue(); },
        "createdOn": n => { shop.createdOn = n.getDateValue(); },
        "deletedByID": n => { shop.deletedByID = n.getNumberValue(); },
        "deletedOn": n => { shop.deletedOn = n.getDateValue(); },
        "id": n => { shop.id = n.getNumberValue(); },
        "isDeleted": n => { shop.isDeleted = n.getBooleanValue(); },
        "modifiedByID": n => { shop.modifiedByID = n.getNumberValue(); },
        "modifiedOn": n => { shop.modifiedOn = n.getDateValue(); },
        "name": n => { shop.name = n.getStringValue(); },
        "ownerUserID": n => { shop.ownerUserID = n.getNumberValue(); },
    }
}
/**
 * The deserialization information for the current model
 ...
 */
// @ts-ignore
export function serializeShop(writer: SerializationWriter, shop: Partial<Shop> | undefined | null = {}) : void {
    if (shop) {
        writer.writeStringValue("caption", shop.caption);
        writer.writeStringValue("comment", shop.comment);
        writer.writeNumberValue("createdByID", shop.createdByID);
        writer.writeDateValue("createdOn", shop.createdOn);
        writer.writeNumberValue("deletedByID", shop.deletedByID);
        writer.writeDateValue("deletedOn", shop.deletedOn);
        writer.writeNumberValue("id", shop.id);
        writer.writeBooleanValue("isDeleted", shop.isDeleted);
        writer.writeNumberValue("modifiedByID", shop.modifiedByID);
        writer.writeDateValue("modifiedOn", shop.modifiedOn);
        writer.writeStringValue("name", shop.name);
        writer.writeNumberValue("ownerUserID", shop.ownerUserID);
        writer.writeAdditionalData(shop.additionalData);
    }
}
/**
 * Serializes information the current object
...
export interface Shop extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
